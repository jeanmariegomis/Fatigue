...
// Returns the private 'App\DataFixtures\Admin' shared autowired service.
...
include_once $this->targetDirs[3].'/src/DataFixtures/Admin.php';

return $this->privates['App\\DataFixtures\\Admin'] = new \App\DataFixtures\Admin(($this->services['security.password_encoder'] ?? $this->load('getSecurity_PasswordEncoderService.php')));
