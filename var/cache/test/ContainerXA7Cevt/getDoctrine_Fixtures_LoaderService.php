...
$instance->addFixtures([0 => ['fixture' => ($this->privates['App\\DataFixtures\\Admin'] ?? $this->load('getAdminService.php')), 'groups' => []], 1 => ['fixture' => ($this->privates['App\\DataFixtures\\AppFixtures'] ?? ($this->privates['App\\DataFixtures\\AppFixtures'] = new \App\DataFixtures\AppFixtures())), 'groups' => []]]);
